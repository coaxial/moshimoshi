...
class OutboundCall < Adhearsion::CallController
  ...
  def run
    ...
    dial "sofia/gateway/cwu/#{@dialled_number}", from: 'Test <15554564567>', ringback: "file:///usr/share/assets/us_ringback_tone.wav" # The path to the file is the path on the FreeSWITCH machine. Only WAV files seem to play.
